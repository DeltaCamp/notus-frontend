              ...
              <div className='row'>
                <div className='col-xs-12 col-lg-8 col-start-lg-3 col-xl-8 col-start-xl-3'>
                  <div className='content'>
                    ...
                    <p>
                      Additionally when you purchase a plan or attempt to purchase a plan through the Site, we collect certain information from you, including your name, billing address, shipping address, payment information (including credit card numbers), email address, and phone number.  We refer to this information as “Order Information.”
                    </p>
                    <p>
                    ...
                    We use
                    <p> the Device Information that we collect to help us screen for potential risk and fraud (in particular, your IP address), and more generally to improve and optimize our Site (for example, by generating analytics about how our customers browse and interact with the Site, and to assess the success of our marketing and advertising campaigns).
                      [[INSERT OTHER USES OF DEVICE INFORMATION, INCLUDING:  ADVERTISING/RETARGETING]]
                    </p>
                    <p>
                      <strong>SHARING YOUR PERSONAL INFORMATION</strong>
                      <br />
                      We share your Personal Information with third parties to help us use your Personal Information, as described above.  For example, we use Rollbar to collect data about errors--you can read more about how Rollbar uses your Personal Information here:  <a href='https://docs.rollbar.com/docs/privacy-policy'>https://docs.rollbar.com/docs/privacy-policy</a>.
                      <br />
                      <br />
                      We also use Google Analytics to help us understand how our customers use the Site--you can read more about how Google uses your Personal Information here:  <a href='https://www.google.com/intl/en/policies/privacy/'>https://www.google.com/intl/en/policies/privacy/</a>.
                      <br />
                    ...
                    <p>
                      ...
                      <br />
                      When you use our Site, we will maintain your Information for our records unless and until you ask us to delete this information.
                    </p>
