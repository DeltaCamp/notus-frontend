/**
 * This code was taken from https://github.com/abinavseelan/react-input-trigger
 * 
 * 
 */
    ...
    if (!triggered) {
      if (
        ...
        this.setState({
          ...
          setTimeout(() => {
            onStart(getHookObject('start', element));
          }, 0);
        });
        return null;
      }
      ...
      if (which === 8 && selectionStart <= triggerStartPosition) {
        this.setState({
          ...
          setTimeout(() => {
            onCancel(getHookObject('cancel', element));
          }, 0);
        });
      ...
      setTimeout(() => {
        onType(getHookObject('typing', element, triggerStartPosition));
      }, 0);
    }
